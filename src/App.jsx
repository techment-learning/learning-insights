...
Thanks!`;
    ...
    return (
      <Modal title="User added" onClose={onClose}>
        ...
        <p style={{ fontSize: 12.5, color: T.inkMuted, lineHeight: 1.5, marginBottom: 16 }}>
          They won't know about this yet — nothing is emailed automatically. Send them a quick note so they know to sign up (they create their own password; it links to this record automatically once they use the same email).
        </p>
        <div style={{ display: "flex", gap: 8 }}>
          ...
          <a href={mailto} style={{ flex: 1, textDecoration: "none" }}>
            <Btn onClick={onClose} style={{ width: "100%", justifyContent: "center" }}><Mail size={14} /> Email invite</Btn>
          </a>
        </div>
      </Modal>
    );
