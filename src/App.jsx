...
import {
  ...
  ClipboardList, ArrowLeft, Filter, RotateCcw, Pencil, Trash2, UserMinus, Download, Copy, Key, Lock, Unlock, GraduationCap
} from "lucide-react";
import {
...
// ---------- Admin Dashboard ----------
function AdminDashboard({ trainings, users, progress, alerts, personalPlans, onAddTraining, onEnroll, onAddTopic, onEditTopic, onDeleteTopic, onUnenroll, onCreatePlan, onEditTraining, onDeleteTraining, onCloneTraining, onToggleLock, onTogglePersonalLock }) {
...
function SelfLearningView({ entries, onAdd, onEdit, onDelete }) {
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 14 }}>
        <p style={{ fontSize: 12.5, color: T.inkMuted, maxWidth: 480 }}>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 12.5, minWidth: 900 }}>
            <thead>
              <tr style={{ borderBottom: `1px solid ${T.line}`, textAlign: "left" }}>
                {["Name", "Learning", "Dates", "%", "Status", "Assigned by", "Quarter", "Remark", ""].map((h) => (
            ...
            <tbody>
              {entries.map((entry, i) => {
                ...
                return (
                  <tr key={entry.id} style={{ borderBottom: i < entries.length - 1 ? `1px solid ${T.line}` : "none" }}>
...
function SelfLearningEntryModal({ entry, onClose, onSave }) {
  ...
  const [quarter, setQuarter] = useState(entry?.quarter || QUARTER_OPTIONS[0]);
