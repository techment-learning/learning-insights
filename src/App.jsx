...
// ---------- Admin Dashboard ----------
function AdminDashboard({ trainings, users, progress, alerts, onAddTraining, onEnroll, onAddTopic, onEditTopic, onDeleteTopic, onUnenroll, onCreatePlan }) {
...
function TrainingCard({ training, users, progress, onEnroll, onAddTopic, onEditTopic, onDeleteTopic, onUnenroll, onCreatePlan }) {
...
function TrainingsView({ trainings, users, progress, onAdd, onEnroll, onAddTopic, onEditTopic, onDeleteTopic, onUnenroll, onCreatePlan }) {
  if (trainings.length === 0) {
...
function CreateLearningPlanModal({ training, willLock, onClose, onSave }) {
  ...
  const valid = cleanLessons.length > 0;

  return (
    <Modal title={`Create learning plan — ${training.title}`} onClose={onClose} wide>
      <p style={{ fontSize: 12.5, color: T.inkMuted, marginBottom: 14, lineHeight: 1.5 }}>
        Add every topic you plan to cover, each with an expected completion date.
        {willLock
